...
dash.register_page(__name__, path="/documentation", path_template="/documentation/<part>", title="Alpine Fan F1 Dashboard | Documentation", description="Have a better understanding of this Formula 1 dashboard or about Alpine Fan !", image_url="https://alpinefan.robcorp.net/assets/images/logo.png")

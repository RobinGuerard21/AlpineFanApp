...
dash.register_page(__name__, path="/contact", title="Alpine Fan F1 Dashboard | Contact", description="Give me some feedbacks or have a Formula 1 talk with me !", image_url="https://alpinefan.robcorp.net/assets/images/logo.png")
